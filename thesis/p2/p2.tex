...
This definition, for example, gives $\profile{3,6,2,7,1,8}[2:4] = \profile{6,3,7}$ and $\profile{1,2,3}\profileconcat\profile{4,5,6}=\profile{1,2,3,4,5,6}$.
...
%   \end{cases},
% \end{equation}
with $SUC$ as defined before. \todo{Figures for explanation}
