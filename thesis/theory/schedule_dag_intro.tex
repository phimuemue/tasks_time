...
\begin{tikzpicture}[scale=.2, anchor=south]
  ...
  \end{scope}
  \draw (sn0x17d67b0.south) -- node[right above, xshift=.4cm]{$0.5$} (sn0x17d57c0.north);
  ...
  \draw (sn0x17d57c0.south) -- node[left above, xshift=-.5]{$0.4$} (sn0x17d5380.north);
  \draw (sn0x17d57c0.south) -- node[right, xshift=.25]{$0.6$} (sn0x17d3a00.north);
  \draw[dashed] (-30, -14.5) -- +(75, 0);
  \draw[dashed] (-30, -24) -- +(75, 0);
  \node at (33, -21) {Intermediate snapshots}
\end{tikzpicture}
%%% Local Variables:
