...
\begin{tikzpicture}[scale=.13333, anchor=south]
  % legende
  \fill[fill=gray!10!white] (-50, -24) rectangle +(105, 11);
  \draw[dashed] (-50, -13) -- +(105, 0);
  \draw[dashed] (-50, -24) -- +(105, 0);
  \node at (40, -21) {Intermediate snapshots};
  \begin{scope}[yshift=\leveltopI cm]
    \matrix (line1)[column sep=0.5cm] {
      ...
      node[left, xshift=-25, yshift=18]{\huge $A$};
      & 
      \\
    };
  \end{scope}
  \begin{scope}[yshift=\leveltopII cm]
    \matrix (line2)[column sep=0.5cm] {
      ...
      node[left, xshift=-25, yshift=18]{\huge $B$};
      & 
      ...
      node[left, xshift=-25, yshift=18]{\huge $C$};
      & 
      \\
    };
  \end{scope}
  \begin{scope}[yshift=\leveltopIII cm]
    \matrix (line3)[column sep=0.5cm] {
      ...
      node[left, xshift=-25, yshift=18]{\huge $B_1$};
      & 
      ...
      node[left, xshift=-25, yshift=18]{\huge $B_2$};
      & 
      ...
      node[left, xshift=-25, yshift=18]{\huge $C_1$};
      & 
      ...
      node[left, xshift=-25, yshift=18]{\huge $C_2$};
      & 
      ...
      node[left, xshift=-25, yshift=18]{\huge $C_3$};
      & 
      \\
    };
  \end{scope}
