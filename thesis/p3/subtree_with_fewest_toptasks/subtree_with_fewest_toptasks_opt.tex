...
\node[draw=black, rectangle split,  rectangle split parts=3] (sn0x83a46b0){
...
\node[draw=black, rectangle split,  rectangle split parts=3] (sn0x83a43d0){
\begin{tikzpicture}[scale=.2]
...
\node[draw=black, rectangle split,  rectangle split parts=3] (sn0x83a4240){
\begin{tikzpicture}[scale=.2]
...
\footnotesize{$33\:33\:33$}
 ...
 & 
\node[draw=black, rectangle split,  rectangle split parts=3] (sn0x83a3da0){
\begin{tikzpicture}[scale=.2]
\node[circle, scale=0.75, fill] (tid0) at (3.75,1.5){};
\node[circle, scale=0.75, fill] (tid1) at (2.25,3){};
\node[circle, scale=0.75, fill, task_scheduled] (tid3) at (0.75,4.5){};
...
\end{scope}
\draw (sn0x83a46b0.south) -- (sn0x83a43d0.north);
\draw (sn0x83a43d0.south) -- (sn0x83a3da0.north);
\draw (sn0x83a43d0.south) -- (sn0x83a4240.north);
\end{tikzpicture}
%%% Local Variables:
