...
\node[draw=black, rectangle split,  rectangle split parts=3] (sn0x8ef4c20){
...
\node[draw=black, rectangle split,  rectangle split parts=3] (sn0x8ef4b48){
\begin{tikzpicture}[scale=.2]
...
\footnotesize{$33\:33\:33$}
 ...
 & 
\node[draw=black, rectangle split,  rectangle split parts=3] (sn0x8ef3f28){
\begin{tikzpicture}[scale=.2]
\node[circle, scale=0.75, fill] (tid0) at (3.75,1.5){};
\node[circle, scale=0.75, fill] (tid1) at (0.75,3){};
\node[circle, scale=0.75, fill] (tid2) at (2.25,3){};
...
\end{scope}
\draw (sn0x8ef4c20.south) -- (sn0x8ef3f28.north);
\draw (sn0x8ef4c20.south) -- (sn0x8ef4b48.north);
\end{tikzpicture}
%%% Local Variables:
