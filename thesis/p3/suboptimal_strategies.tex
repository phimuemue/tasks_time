...
\begin{figure}[ht]
  ...
  \begin{subfigure}{.5\textwidth}
    \centering
    \input{p3/2hlf_suboptimal/0012233689101112_subopt}
    \caption{HLF-Schedule}
  \end{subfigure}
  \quad
  \begin{subfigure}{.40\textwidth}
    \centering
    \input{p3/2hlf_suboptimal/0012233689101112_opt}
...
\begin{figure}[ht]
  ...
  \begin{subfigure}{.45\textwidth}
    ...
    \begin{tikzpicture}[scale=.2, anchor=south]
      ...
      \end{scope}
    \end{tikzpicture}  
    \caption{Removing the root yields two subtrees with optimal expected run times (for three processors) as noted.}
  \end{subfigure}
...
\begin{figure}[th]
  ...
  \begin{subfigure}{.45\textwidth}
    \centering
    \input{p3/suboptimal/000111223_opt458}
    \caption{Optimal schedule starting with tasks 4,5 and 8.}
  \end{subfigure}
  \quad
  \begin{subfigure}{.45\textwidth}
    \centering
    \input{p3/suboptimal/000111223_opt468}
