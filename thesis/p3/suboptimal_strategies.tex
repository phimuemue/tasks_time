...
Finally, we conclude some properties that \emph{optimal} seem to fulfill.
...
\begin{figure}[th]
  ...
  \caption{The optimal schedule has two tasks (5 and 6) that have both scheduled and non-scheduled leaves as predecessors.}
