...
\node[draw=black, rectangle split,  rectangle split parts=3] (sn0x897a298){
...
\node[draw=black, rectangle split,  rectangle split parts=3] (sn0x897a1e0){
\begin{tikzpicture}[scale=.2]
\node[circle, scale=0.75, fill] (tid0) at (3,1.5){};
\node[circle, scale=0.75, fill] (tid1) at (1.5,3){};
\node[circle, scale=0.75, fill, task_scheduled] (tid3) at (0.75,4.5){};
...
\footnotesize{$33\:67$}
 ...
 & 
\node[draw=black, rectangle split,  rectangle split parts=3] (sn0x8978a18){
\begin{tikzpicture}[scale=.2]
...
\end{scope}
\draw (sn0x897a298.south) -- (sn0x8978a18.north);
\draw (sn0x897a298.south) -- (sn0x897a1e0.north);
\end{tikzpicture}
%%% Local Variables:
