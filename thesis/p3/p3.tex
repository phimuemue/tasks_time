...
\subsection{A counter example disproving P3L}
\label{sec:counter-example-disproving-p3l-optimality}
...
\subsection{A counter example disproving P1S}
\label{sec:counter-example-disproving-p1s-optimality}
...
This shows that it can be useful to accept a shorter longer time with only one processor busy, probably acchieving a longer timespan where three processors are busy.
