...
\begin{table}[th]
  ...
  \begin{tabular}[ht]{ccccccc}
    ...
    17 &  &  & 6399 & 755.86 & &  
  \end{tabular}
  \caption{\todo{Fill table!}Conjecture-improved LEAF scheduling with HLF when encountering a degenerate intree or a parallel chain and scheduling as much topmost tasks as possible}
