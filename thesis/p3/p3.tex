...
\begin{theorem}
  There are intrees for which the optimal schedule has to pick the topmost task, but the other two tasks are \emph{both} on a lower level than another, unscheduled task. It is $(0, 0, 1, 2, 3, 4, 4, 5, 5, 8, 10, 11, 12)$ and $(0, 0, 1, 2, 2, 3, 3, 6, 8, 9, 10, 11, 12)$.
\end{theorem}
