...
\begin{figure}[ht]
  ...
  \begin{subfigure}{.45\textwidth}
    \centering
    \input{p3/hlfnfc_not_optimal/000111223_hlfnfc}
  ...
  \end{subfigure}
  \caption{HLF with no free paths is not necessarily optimal.\todo{PDFs draus bauen, dann sollte es auch anständig aligniert sein.}}
