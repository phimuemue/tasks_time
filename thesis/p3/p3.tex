...
Moreover, it is known that preemtive scheduling yields better results than non-preemtive scheduling. As an example, \cite{MoritzMaasDiploma} shows the intree $(0,0,1,1,1,2,2,2)$. This intree is -- non-preemtively -- optimally processed by starting out with tasks 3, 4 and 5. The optimal preemtive schedule

\begin{figure}[ht]
  \centering
  \begin{subfigure}{.45\linewidth}
    \centering
    \includegraphics{p3/preemtive/00111222hlf.pdf}
    \caption{Optimal non-preemtive schedule.}
  \end{subfigure}
  \quad

  \caption{Preemtive vs. non-preemtive scheduling for $(0,0,1,1,1,2,2,2)$}
