...
\node[draw=black, rectangle split,  rectangle split parts=3] (sn0xa0991c8){
...
\node[draw=black, rectangle split,  rectangle split parts=3] (sn0xa099cf8){
\begin{tikzpicture}[scale=.2]
...
\node[draw=black, rectangle split,  rectangle split parts=3] (sn0xa098ce8){
\begin{tikzpicture}[scale=.2]
...
\footnotesize{$33\:33\:33$}
 ...
 & 
\node[draw=black, rectangle split,  rectangle split parts=3] (sn0xa099b48){
\begin{tikzpicture}[scale=.2]
\node[circle, scale=0.75, fill] (tid0) at (4.5,1.5){};
\node[circle, scale=0.75, fill] (tid1) at (2.25,3){};
\node[circle, scale=0.75, fill] (tid3) at (1.5,4.5){};
...
\end{scope}
\draw (sn0xa0991c8.south) -- (sn0xa099cf8.north);
\draw (sn0xa099cf8.south) -- (sn0xa099b48.north);
\draw (sn0xa099cf8.south) -- (sn0xa098ce8.north);
\end{tikzpicture}
%%% Local Variables:
