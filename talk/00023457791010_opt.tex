...
\node[draw=black, rectangle split,  rectangle split parts=2] (sn0x9a91b20){
\begin{tikzpicture}[scale=.2]
...
\footnotesize{7.34803}
 ...
 & 
\node[draw=black, rectangle split,  rectangle split parts=2] (sn0x9a90b48){
\begin{tikzpicture}[scale=.2]
\node[circle, scale=0.75, fill] (tid0) at (3.75,1.5){};
\node[circle, scale=0.75, fill] (tid1) at (0.75,3){};
\node[circle, scale=0.75, fill] (tid2) at (2.25,3){};
...
\end{scope}
\draw (sn0x9a91c28.south) -- (sn0x9a90b48.north);
\draw (sn0x9a91c28.south) -- (sn0x9a91b20.north);
\end{tikzpicture}
%%% Local Variables:
