...
\node[draw=black, rectangle split,  rectangle split parts=2] (sn0x9b5bb20){
\begin{tikzpicture}[scale=.2]
...
\footnotesize{7.34803}
 ...
 & 
\node[draw=black, rectangle split,  rectangle split parts=2] (sn0x9b5b188){
\begin{tikzpicture}[scale=.2]
\node[circle, scale=0.75, fill] (tid0) at (3,1.5){};
\node[circle, scale=0.75, fill] (tid1) at (0.75,3){};
\node[circle, scale=0.75, fill] (tid2) at (2.25,3){};
...
\end{scope}
\draw (sn0x9b5bc80.south) -- (sn0x9b5b188.north);
\draw (sn0x9b5bc80.south) -- (sn0x9b5bb20.north);
\end{tikzpicture}
%%% Local Variables:
