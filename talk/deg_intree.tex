...
\node[rectangle split,  rectangle split parts=1] (sn0x859f630){
...
\node[circle, scale=0.75, fill] (tid8) at (9,6){};
\node[circle, scale=0.75, fill] (tid9) at (8.25,7.5){};
\node[circle, scale=0.75, fill] (tid10) at (9.75,7.5){};
\draw[](tid8) -- (tid9);
\draw[](tid8) -- (tid10);
\draw[](tid5) -- (tid6);
\draw[](tid5) -- (tid7);
